...
public class PrintVisitor implements Visitor {
	@Override
	public void visit(Program main, JTextArea console) {
		if(main.getList() != null) main.getList().accept(this, console);
		console.append("\n");
	}
	
	@Override
	public void visit(Declaraciones decl, JTextArea console){
		if(decl.getList() != null){
			for (Declaraciones2 varDeclList : decl.getList()) {
				for(Declaraciones3 varDecl : varDeclList.getList())
					console.append("");
			}
		}
		console.append("\n");
